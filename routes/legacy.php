...
// Web antigua de MyRaces (cuentas, carreras, estadísticas, admin…). YA NO SE CARGA: la web es solo la
// portada de la app para iPhone (routes/web.php). Se guarda por si hiciera falta recuperarla.
