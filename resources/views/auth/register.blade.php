<x-guest-layout>
    <div class="px-6 pt-8 pb-7">
        <h2 class="text-xl font-extrabold text-slate-900 mb-1">Crea tu cuenta</h2>
        <p class="text-sm text-slate-500 mb-7">Empieza a registrar tus carreras gratis</p>
        ...
        <div class="space-y-2.5 mb-6">
            <a href="{{ route('social.redirect', 'google') }}"
               class="flex items-center justify-center gap-3 w-full border border-slate-200 rounded-xl px-4 py-3 text-sm font-semibold text-slate-700 hover:bg-slate-50 hover:border-slate-300 transition-colors">
            ...
            <a href="{{ route('social.redirect', 'facebook') }}"
               class="flex items-center justify-center gap-3 w-full bg-[#1877F2] hover:bg-[#166FE5] rounded-xl px-4 py-3 text-sm font-semibold text-white transition-colors">
            ...
            <a href="{{ route('social.redirect', 'strava') }}"
               class="flex items-center justify-center gap-3 w-full bg-[#FC4C02] hover:bg-[#e84400] rounded-xl px-4 py-3 text-sm font-semibold text-white transition-colors">
                <svg class="w-5 h-5 flex-shrink-0" fill="currentColor" viewBox="0 0 24 24">
                    <path d="M15.387 17.944l-2.089-4.116h-3.065L15.387 24l5.15-10.172h-3.066m-7.008-5.599l2.836 5.598h4.172L10.463 0l-7 13.828h4.169"/>
                </svg>
                Registrarse con Strava
            </a>
        </div>
        ...
        <div class="relative mb-6">
            ...
            <div class="relative flex justify-center text-xs">
                <span class="px-3 bg-white text-slate-400 font-semibold">O con email</span>
            </div>
        </div>
        ...
        <p class="text-center text-sm text-slate-500 mt-6">
            ¿Ya tienes cuenta?
            <a href="{{ route('login') }}" class="text-orange-500 font-bold hover:text-orange-400 transition-colors">Inicia sesión</a>
        </p>
    </div>
</x-guest-layout>
